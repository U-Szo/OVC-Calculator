...
##STYLESHEETS IMPORT##
######################
import module_view.modules_assigning_values.assigning_values_stylesheets.assign_window_stylesheet as awss
...
class Ui_AssignWindow(object):
    def setupUi(self, MainWindow,admin):
        ...
        self.modify_selected_vector_button.clicked.connect(self.show_values_window_vector)
        ...
        self.vector_tree_widget.itemDoubleClicked.connect(self.show_values_window_vector)
        ...
        self.number_of_vectors_combobox.activated.connect(self.hide_and_show_vector_items)
        ...
        self.modify_selected_matrix_button.clicked.connect(self.show_values_window_matrix)
        ...
        self.matrix_tree_widget.itemDoubleClicked.connect(self.show_values_window_matrix)
        ...
        self.number_of_matrix_combobox.activated.connect(self.hide_and_show_matrix_items)
        ...
        self.tab_widget.currentChanged.connect(self.admin.ui.update_matrix_tree_items_on_tab_change)
        QtCore.QMetaObject.connectSlotsByName(MainWindow)

        self.type_of_assign_to_make = 0

    def hide_and_show_vector_items(self):
    ...
    def hide_and_show_matrix_items(self):
    ...
    def show_values_window_vector(self):
        ...
        self.admin.assign_values_window.valueswindow.ui.hide_and_show_rows()
        self.admin.assign_values_window.valueswindow.ui.hide_and_show_columns()
    ...
    def show_values_window_matrix(self):
        self.admin.assign_values_window.valueswindow.hide()
