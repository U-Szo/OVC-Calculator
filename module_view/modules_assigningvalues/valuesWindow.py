...
##STYLESHEETS IMPORT##
######################
import module_view.modules_assigningvalues.assigningvalues_stylesheets.ValuesWindowStylesheet as vwss
...
class Ui_ValuesWindow(object):
    def setupUi(self, MainWindow,admin):
        ...
        self.apply_button.clicked.connect(self.applyAssign)
        ...
        self.cancel_button.clicked.connect(self.cancelAssign)
        ...
        self.rows_combobox.activated.connect(self.hideAndShowRows)
        ...
        self.columns_combobox.activated.connect(self.hideAndShowColumns)
    ...
    def applyAssign(self):
        if self.admin.ui.type_of_assign_to_make == "vector":
            ...
            self.admin.admin.admin.modifyVectors(selected_vector_item,selected_vector_item_rows,selected_vector_item_columns,self.new_vector)
